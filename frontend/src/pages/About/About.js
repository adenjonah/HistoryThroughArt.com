    ...
    <div className='pagecontainer'>
      ...
      <div className='team-cards'>
        <div className='team-card'>
          <a href="https://www.linkedin.com/in/caleb-stewart-281594274/" target="_blank" rel="noopener noreferrer">
        ...
        <div className='team-card'>
          <a href="https://www.spokesman.com/stories/2010/mar/11/teacher-of-year-honors-go-to-three/" target="_blank" rel="noopener noreferrer">
        ...
        <div className='team-card'>
          <a href="https://www.linkedin.com/in/jonah-aden/" target="_blank" rel="noopener noreferrer">
      ...
      <p className='aboutblurb'>This project began in the summer of 2024 with the initial goal of creating a platform to centralize the educational content that Mrs. Korus had produced for her AP Art History classes. Jonah took AP Art History his senior year of high school and really enjoyed the content and teaching style that Mrs. Korus provided. He had the idea for this site as an aid for in-class instruction. Jonah shared the idea with Caleb, a fellow Computer Science major, and Caleb was immediately on board with the mission. The two began planning and creating design mockups and pitched the idea to Mrs. Korus, who loved it. Over the summer they developed a basic site, and they plan on adding a plethora of features over the school year.</p>
